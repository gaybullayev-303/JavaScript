...
//   ];
// 1 - masala 
// let obj2 = {id: 5, firstName: "Ali", lastName: "Valiyev", age: 25, status: "Dasturchi"}
// let first = people.find((obj) => obj.id === 5 ? console.log(obj = obj2) : console.log(obj));



//  2 - masala
// let second = people.filter((obj) => obj.lastName.includes("va"))
// console.log(second);
